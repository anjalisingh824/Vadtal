...
public class DonationReceiptCheque1 {
	...
	public void testVadtal() throws Exception {
		...
		while (iterator.hasNext()) {
			...
			// cheque/draft
			driver.findElement(
					By.xpath("//input[@type='text'][following-sibling::label[contains(text(),'Cheque/Draft no.')]]"))
			...
			// note
			driver.findElement(
					By.xpath("//input[@type='text'][following-sibling::label[contains(text(),'Enter note here')]]"))
					.sendKeys(ExcelUtils.getCellData(row, 17, Constants.DONATION_RECIEPT));

			// click on the special note check box
			driver.findElement(By
			...
			// special note
			driver.findElement(By
					.xpath("//input[@type='text'][following-sibling::label[contains(text(),'Enter special note here')]]"))
					.sendKeys(ExcelUtils.getCellData(row, 18, Constants.DONATION_RECIEPT));

			Thread.sleep(5000);
			// click on save and print
			driver.findElement(By.cssSelector(".form-btn-submit")).click();
			Thread.sleep(2000);
		}
